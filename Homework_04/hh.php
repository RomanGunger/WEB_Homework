...
$exp = [
	[
        ...
        'date' => 'Jan 2015 -',
   		'value' => 'Lorem ipsum dolor sit amet. Praesentium magnam consectetur vel in deserunt aspernatur est reprehenderit sunt hic. Nulla tempora soluta ea et odio, unde doloremque repellendus iure, iste.',
        
	],
    [
        'name' => 'Web Developer / something.com',
        'date' => 'Mar 2012 - Dec 2014',
        'value' => 'Consectetur adipisicing elit. Praesentium magnam consectetur vel in deserunt aspernatur est reprehenderit sunt hic. Nulla tempora soluta ea et odio, unde doloremque repellendus iure, iste.',
	],
    [
  ...
  <div class="w3-row-padding">
    ...
    <div class="w3-twothird">
      ...
      <div class="w3-container w3-card w3-white w3-margin-bottom">
        ...
        <?php foreach($exp as $key => $job): ?>
        
        <div class="w3-container">
          <h5 class="w3-opacity"><b><?=$job['name']?></b></h5>
          <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i> <?=$job['date']?>
          <?php if ($key == 0): ?>
